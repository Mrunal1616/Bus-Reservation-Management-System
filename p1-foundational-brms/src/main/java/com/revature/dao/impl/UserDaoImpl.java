...
public class UserDaoImpl implements UserDao {
	...
	public void update(String userId, User newUser) {
		...
		try {
			...
			preparedStatment.setString(4, newUser.getUsername());
			preparedStatment.setString(5, newUser.getEmail());
			preparedStatment.setString(6, newUser.getPhoneNo());
			preparedStatment.setString(7, newUser.getDateOfBirth());
			preparedStatment.setInt(8, newUser.getAge());
			preparedStatment.setString(9, newUser.getAddress());
			preparedStatment.setString(10, newUser.getPhysicalDisability());
			preparedStatment.setString(11, newUser.getIdentityProof());
			preparedStatment.setString(12, userId);
	...
	public List<User> allUsers() throws SQLException {
		...
		try {
			...
			rs = preparedStatment.executeQuery();
			while (rs.next()) {
				currentUser = new User(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getInt(8), rs.getString(9), rs.getString(10), rs.getString(11));
